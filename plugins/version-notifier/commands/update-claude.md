...
- **Question**: "Upgrade Claude Code from v{current} to v{latest}?"
- **Options**: Yes / No
...
1. Search: `"Claude Code v{latestVersion}" site:anthropic.com`
2. Search: `"Claude Code v{latestVersion}" release notes`
...
4. **Structure**: Update Summary → New Features in Detail → Improvements & Fixes
